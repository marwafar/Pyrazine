...
absorp_22_02=np.genfromtxt("response_ESA_R_22_02.txt", delimiter=" ")
absorp_22_01=np.genfromtxt("response_ESA_R_22_01.txt", delimiter=" ")
...
spect=open("spectra_rephase_T30.txt","w+")
for i in range(n_step):
 for j in range(n_step):
