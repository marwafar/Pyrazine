...
bleach_01=np.genfromtxt("response_GB_R_01.txt", delimiter=" ")
emission_01=np.genfromtxt("response_SE_R_01.txt", delimiter=" ")
bleach_02=np.genfromtxt("response_GB_R_02.txt", delimiter=" ")
emission_02=np.genfromtxt("response_SE_R_02.txt", delimiter=" ")
emission_02_01=np.genfromtxt("response_SE_R_02_01.txt", delimiter=" ")
absorp_22_02=np.genfromtxt("response_ESA_R_22_20.txt", delimiter=" ")
absorp_22_01=np.genfromtxt("response_ESA_R_22_10.txt", delimiter=" ")
absorp_11_02=np.genfromtxt("response_ESA_R_11_02.txt", delimiter=" ")
absorp_11_01=np.genfromtxt("response_ESA_R_11_01.txt", delimiter=" ")

print(bleach_01.shape,bleach_02.shape)
...
S_SE_01=(emission_01[:,2]+emission_01[:,3]*1j)*complex(0.0,1.0)*np.exp(-(emission_01[:,0]+emission_01[:,1])/(dephas))
S_GB_02=(bleach_02[:,2]+bleach_02[:,3]*1j)*complex(0.0,1.0)*np.exp(-(bleach_02[:,0]+bleach_02[:,1])/(dephas))
S_SE_02=(emission_02[:,2]+emission_02[:,3]*1j)*complex(0.0,1.0)*np.exp(-(emission_02[:,0]+emission_02[:,1])/(dephas))
...
for j in range(n_step):
 for i in range(n_step):
  temp[i]=BW[i,j]
 FW[:,j]=np.fft.fft(temp)

spect=open("spectra_rephase_T0.txt","w+")
for i in range(n_step):
 for j in range(n_step):
